...
export class ColumnComponent {
  ...
  ngOnInit(): void {
    ...
    this._groupedstackedcolumns(
      '["--tb-primary", "--tb-success","--tb-secondary", "--tb-warning"]'
    );
